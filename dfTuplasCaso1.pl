...
initial_state(ptm,ptm(izq,[(alberto, 1),  (beatriz, 2),  (carlos, 5),  (dora, 10),  (emilio, 15)],[],28,0)).
final_state(ptm(der,[],[(alberto, 1),  (beatriz, 2),  (carlos, 5),  (dora, 10),  (emilio, 15)],28,28)).
...
precedes((alberto,1),[(carlos,5),(dora,10),(emilio,15)]).
precedes((beatriz,2),[(alberto,1),(carlos,5)]).
precedes((alberto,1),[(carlos,5)]).
precedes2([(alberto,1),(beatriz,2)],[]).
precedes2([(dora,10),(emilio,15)],[(beatriz,2)]).
precedes2([(alberto,1),(beatriz,2)],[(dora,10),(emilio,15)]).
precedes2([(alberto,1),(carlos,5)],[(beatriz,2),(dora,10),(emilio,15)]).
...
insert_sort00(ptm(izq,I,D,TT,TA),L):-insert_sort2(I,I2),L=ptm(izq,I2,D,TT,TA).
insert_sort00(ptm(der,I,D,TT,TA),L):-insert_sort2(D,D2),L=ptm(der,I,D2,TT,TA).
